...
;; (sqrt(n)), you should expect that testing for primes around 10,000 should
...
; 1000033
; 1000037
;; Runs too fast, but I believe this is bounds for this algorithm
;; Large numbers make it hard to have much of a range due to stack depth limits
