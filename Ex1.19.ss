...
;of transformations Tpq, where Tpq transforms the pair (a,b) according to a  bq + aq + ap
;and b  bp + aq. Show that if we apply such a transformation Tpq twice, the effect is the same as
;using a single transformation Tp'q' of the same form, and compute p' and q' in terms of p and q.
